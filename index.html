...
<head>
  ...
  CSS
  ============================================= -->
    <link rel="stylesheet" href="{{ asset('assets/fe/css/linearicons.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('assets/fe/css/nouislider.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/fe/css/ion.rangeSlider.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/fe/css/ion.rangeSlider.skinFlat.css') }}" />
...
<body>
        ...
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light main_box">
                <div class="container">
                    ...
                    <a class="navbar-brand logo_h" href="index.html"><img src="{{ asset('assets/fe/img/') }}"
                            alt=""></a>
                        ...
                        <div class="row single-slide align-items-center d-flex">
                            ...
                            <div class="col-lg-7">
                                <div class="banner-img">
                                    <img class="img-fluid" src="{{asset('assets/fe/img/banner/banner-img.png')}}" alt="">
                                </div>
                            </div>
                        </div>
                        <!-- single-slide -->
    ...
    <script src="{{ asset('assets/fe/js/vendor/jquery-2.2.4.min.js') }}"></script>
    ...
    <script src="{{ asset('assets/fe/js/jquery.sticky.js') }}"></script>
    <script src="{{ asset('assets/fe/js/nouislider.min.js') }}"></script>
    <script src="{{ asset('assets/fe/js/countdown.js') }}"></script>
    <script src="{{ asset('assets/fe/js/jquery.magnific-popup.min.js') }}"></script>
    <script src="{{ asset('assets/fe/js/owl.carousel.min.js') }}"></script>
    <!--gmaps Js-->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCjCGmQ0Uq4exrzdcL6rvxywDDOvfAu6eE"></script>
    <script src="{{ asset('assets/fe/js/gmaps.min.js') }}"></script>
